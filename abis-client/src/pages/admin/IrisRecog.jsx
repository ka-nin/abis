...
import { EyeIcon, WifiIcon, CheckCircleIcon, XCircleIcon, AlertTriangleIcon } from '../../components/icons'
...
const LATEST_CAPTURE = {
  vrn: 'VRN-2026-005512',
  boundaryVisibility: 93,
  pupilIrisContrast: 87,
  sharpness: 90,
}
...
export default function IrisRecog() {
  ...
  const boundaryPass = LATEST_CAPTURE.boundaryVisibility >= qualityThreshold
  const contrastPass = LATEST_CAPTURE.pupilIrisContrast >= qualityThreshold
  const sharpnessPass = LATEST_CAPTURE.sharpness >= qualityThreshold
      ...
      <div className="mt-4 rounded-2xl border border-slate-200 bg-white p-5">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-slate-400">{LATEST_CAPTURE.vrn} · Iris capture parameters</p>
          </div>
          {decision && (
        ...
        <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-3">
          <QualityMetric label="Boundary Visibility" value={LATEST_CAPTURE.boundaryVisibility} unit="%" pass={boundaryPass} />
          <QualityMetric label="Pupil-Iris Contrast" value={LATEST_CAPTURE.pupilIrisContrast} unit="%" pass={contrastPass} />
          <QualityMetric label="Sharpness" value={LATEST_CAPTURE.sharpness} unit="%" pass={sharpnessPass} />
        </div>
