...
import { ArrowLeftIcon, ArrowRightIcon, IdCardIcon } from '../../components/icons'
...
export default function Step3({ onBack, onVerify }) {
      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        ...
        {selected && (
          <div className="mt-6 flex items-center gap-3 rounded-2xl border border-blue-200 bg-blue-50 px-5 py-4 text-sm text-blue-700">
            ...
            {selected} selected. Click &quot;Verify ID&quot; to proceed.
          </div>
        )}
